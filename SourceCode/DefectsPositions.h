...
namespace unfolding {
	...
	public:
		...
		void findDefects();					// Reads defect positions if given, otherwise locates the defects by finding topological defect locations
		void findConnectivity();			// Calcualtes large triangles connectivity among defects by implementing sliding window search algorithm
